...
from datasets.FPHA_Loader import DataLoaderFPHA
...
if __name__ == '__main__':
    ...
    ap.add_argument('--data_path', type=str, default='data/fpha/', help='data path')
    ap.add_argument('--output_dir', type=str, default='outputs_fpha', help='output dir')
    ap.add_argument('--model_name', type=str, default='MSNet')
    ap.add_argument('--dataset', type=str, default='FPHA', help='dataset')
    ap.add_argument('--device', type=str, default='cpu', help='device')
    ap.add_argument('--description', type=str, default='63,56,46,36,k=4,5,6,no scheduler,qk_dim=4', help='description')
    ...
    DataLoader = DataLoaderFPHA(args["data_path"], args["bs"])
