...
from datasets.MDSD_Loader import DataLoaderMDSD
...
if __name__ == '__main__':
    ...
    ap.add_argument('--bs', type=int, default=20, help='batch size')
    ap.add_argument('--model_path', type=str, default='')
    ap.add_argument('--data_path', type=str, default='data/MDSD_py.mat', help='data path')
    ap.add_argument('--output_dir', type=str, default='outputs_mdsd', help='output dir')
    ap.add_argument('--model_name', type=str, default='MSNet')
    ap.add_argument('--dataset', type=str, default='MDSD', help='dataset')
    ap.add_argument('--device', type=str, default='cpu', help='device')
    ap.add_argument('--description', type=str, default='400,200,100,49,no scheduler', help='description')
    ...
    DataLoader = DataLoaderMDSD(args["data_path"], args["bs"])
