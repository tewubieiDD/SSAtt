...
class DataLoaderFPHA:
    def __init__(self, data_path, batch_size):
        ...
        self._train_generator = data.DataLoader(DatasetFPHA(path_train, names_train), batch_size=batch_size,
                                                shuffle='True')
        self._val_generator = data.DataLoader(DatasetFPHA(path_test, names_test), batch_size=batch_size,
                                              shuffle='False')
...
#     data_path = "../data/fpha"
#     batch_size = 30
#     data_loader = DataLoaderFPHA(data_path, batch_size)
#
